...
const games = [
    ...
    },
    {
        ...
        categories: ["accion", "aventura","estrategia"],
        requirements: "altos"
    },
    {
        id: 22,
    ...
    },
    {
        id: 23,
        title: "NBA 2k14",
        image: "imagenes css/2k.jpg",
        categories: ["accion", "deportes"],
        requirements: "medios"
    },
    {
        id: 24,
    ...
    },
    {
        id: 26,
        title: "The Witcher",
        image: "imagenes css/Witcher.jpg",
        categories: ["rpg", "aventura"],
        requirements: "medios"
    },
    {
...
function filterGames(category, requirements) {
    // Si la categoría es un nivel de requisitos, filtrar solo por requisitos
    const requirementsLevels = ['bajos', 'medios', 'altos'];
    if (requirementsLevels.includes(category.toLowerCase())) {
        return games.filter(game =>
            game.requirements.toLowerCase() === category.toLowerCase()
        );
    }

    // Si es una categoría, filtrar por categoría y requisitos
    return games.filter(game =>
...
function updateGamesGrid(filteredGames) {
    ...
    if (gamesGrid) {
        ...
        if (filteredGames.length === 0) {
            gamesGrid.innerHTML = `<p>No se encontraron juegos en esta categoría.</p>`;
        } else {
...
function initializeCategoryFilters() {
    ...
    const validCategories = [
        'accion', 'aventura', 'estrategia', 'carreras',
        'terror', 'rpg', 'deportes',
        'bajos', 'medios', 'altos'
    ];
    ...
    categoryLinks.forEach(link => {
        link.addEventListener('click', function(e) {
            ...
            if (sectionTitle) {
                sectionTitle.textContent = category === 'bajos' || category === 'medios' || category === 'altos'
                    ? `Juegos de ${category} requisitos`
                    : `Juegos de ${category} - ${requirements} requisitos`;
            }
